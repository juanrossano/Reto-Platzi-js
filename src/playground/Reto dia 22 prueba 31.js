// console.log();
console.log("Personaliza productos de una tienda");
...
class ShippingInsuranceDecorator extends Product {
    ...
    getPrice() {
      // Tu código aquí 👈
      return this.producto.getPrice()+20;
    }
  
    getDescription() {
      // Tu código aquí 👈
      return this.producto.getDescription()+ " con seguro de envío";
    }
}
...
class WarrantyDecorator extends Product {
    ...
    getDescription() {
      // Tu código aquí 👈
      return this.producto.getDescription()+ " con garantía";
    }
}
